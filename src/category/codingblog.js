...
import '../book.css';
class CodeBlog extends Component{
    constructor(props){
        super(props);
        this.state={
            books:[],
    ...
    componentDidMount=()=>{
        ...
        .then((data)=>{
            ...
            var result=data.filter(obj=>obj.category=="coding");
...
<div class="row">
  <div class="leftcolumn">
    <h1 style={{textAlign:'center',fontWeight:'bolder',textShadow:'2px 2px 0px'}}>Coding Blogs</h1>
  {netBooks.map(
                    book=>
